...
```{r}
library(readr)
Population_Growth_Fertility_and_Mortality_Indicators <- read_csv("~/Downloads/Population Growth, Fertility and Mortality Indicators.csv")
View(Population_Growth_Fertility_and_Mortality_Indicators)
```

```{r}
Population_Growth_Fertility_and_Mortality_Indicators 
```
